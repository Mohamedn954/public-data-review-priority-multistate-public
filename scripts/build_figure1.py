...
STAGES = [
    ("Documented oversight gap", "Sec. 1: independent federal and\nstate audit and inquiry evidence"),
    ("Claims-only oversight leaves gaps", "Sec. 1.3: access and transparency gaps\nfor most oversight actors"),
    ("20-indicator framework", "Sec. 2: derived from Minnesota's\nenforcement record, 3 domains"),
    ("Phase 1: Washington pilot", "Sec. 3.1: n=3,457, implemented at\nscale, new audit evidence and policy context"),
    ("Phase 1: Oregon portability test", "Sec. 3.2–3.3: n=792, pipeline transfers;\n1 threshold required recalibration"),
    ("Disclosed, two-state method", "Sec. 3.4–6: heterogeneous evidentiary\nsupport, limits stated explicitly"),
    ("Phase 2: claims-informed validation (next)", "Sec. 7: first stage of a\nbroader research agenda"),
]
